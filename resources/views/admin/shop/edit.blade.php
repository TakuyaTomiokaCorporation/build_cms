...
@section('main')
    <div class="container mt-5">
        <h1 class="text-center jumbotron">ショップの編集</h1>
    </div>
    <div class="container">
    ...
    <div class="container mt-5">
        <form class="form-horizontal" action="{{ route('shop.update', $shop->id)}}" method="post">
            @csrf
            @method('PATCH')
            ...
            <div class="form-group row">
                ...
                <input class="col-sm-10 form-control-lg" name="shop_name" type="text" id="shop_name" value="{{ $shop->shop_name }}" required>
            ...
            <div class="form-group row">
                ...
                <input class="col-sm-10 form-control-lg" name="post_number" type="text" id="post_number" value="{{ $shop->post_number }}">
            ...
            <div class="form-group row">
                ...
                <input class="col-sm-10 form-control-lg" name="shop_address" type="text" id="shop_address" value="{{ $shop->shop_address }}" required>
            ...
            <div class="form-group row">
                ...
                <input class="col-sm-10 form-control-lg" name="shop_tel" type="text" id="shop_tel" value="{{ $shop->shop_tel }}" required>
