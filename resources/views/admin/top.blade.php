    ...
    <div class="row">
        ...
        <div class="col-sm-6">
            <div class="card img-thumbnail">
                <img class="card-img-top" src="/images/admin/product.jpg" alt="製品登録の画像">
                <div class="card-body px-2 py-3">
                <h5 class="card-title">製品登録</h5>
                <p class="card-text">製品の登録や編集はこちらから行えます。</p>
                <p class="mb-0"><a href={{ route('product')}} class="btn btn-primary stretched-link">ボタン</a></p>
                </div>
            </div>
        </div>
        {{-- 最新情報 --}}
        <div class="col-sm-6">
            <div class="card img-thumbnail">
                ...
                <p class="mb-0"><a href="{{ route('news') }}" class="btn btn-primary stretched-link">ボタン</a></p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="row">
                ...
                <div class="col-sm-6">
                    <div class="card img-thumbnail">
                        ...
                        <p class="mb-0"><a href="{{ route('product_news')}}" class="btn btn-primary stretched-link">ボタン</a></p>
                        </div>
                    </div>
                </div>
                {{-- 店舗の登録 --}}
                <div class="col-sm-6">
                    <div class="card img-thumbnail">
                        ...
                        <p class="mb-0"><a href="{{ route('shop')}}" class="btn btn-primary stretched-link">ボタン</a></p>
                        </div>
                    </div>
                </div>
            </div>
