...
<div id="" class="main" role="main">
    ...
    <div class="swiper-container gallery-top">
        <div class="swiper-wrapper">
            <div class="swiper-slide movie-wrap"><video src="{{ asset('images/user/indigo_15.mp4') }}" playsinline autoplay muted controls width="1020"></video></div>
            <div class="swiper-slide"><a href="https://www.youtube.com/watch?v=4pmZ0NGdWSY" target="_blank"><img src="{{ asset('images/user/pnk_mv.png') }}" alt=""></a></div>
