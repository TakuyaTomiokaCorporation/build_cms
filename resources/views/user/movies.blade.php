...
<div id="" class="main w1020 w98 m_auto" role="main">
    <h2 class="pt20 border_b mb20">製品動画</h2>
    <section class="mb20">
        <div>
            <p class="read">バリュトレ！ではAVIOT製品の魅力を動画でお伝え致します。</p>
            <p class="mt10"><a href="https://www.youtube.com/channel/UChHmHYsAGNVZJEhN8yl7H9g" target="_blank" class="btn_Blk">バリュトレ！チャンネルはこちら</a></p>
