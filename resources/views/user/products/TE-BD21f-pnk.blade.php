...
<article class="w1020 w98 m_auto">
    ...
    <div>
    <p class="product_text">コラボレーションモデル専用にデザインされたセミハードケースを制作しました。また、ピエール中野さんのアイデアにより、イヤホンの片側が落下しても紛失しないよう、両方のイヤホンを繋ぐストラップも同梱しています（通常モデルにも採用させて頂きました）。専用ケースの詳細は後日本ページに掲載させて頂く予定です。</p>
