...
<div id="" class="main" role="main">
    ...
    <div class="">
        <p class="alc"><img src="{{ asset('images/products/WE-D01c-01.jpg') }}"></p>
        <div class="flex_ImgR">
    ...
    <p class="alc"><img src="{{ asset('images/products/WE-D01c-02.jpg') }}"></p>
    <div>
    ...
    <p class="alc"><img src="{{ asset('images/products/WE-D01c-03.jpg') }}"></p>
    <div class="">
    ...
    <p class="alc"><img src="{{ asset('images/products/WE-D01c-04.jpg') }}"></p>
    <div class="flex_ImgR">
    ...
    <p class="alc"><img src="{{ asset('images/products/WE-D01c-05.jpg') }}"></p>
    <div class="">
        <div>
    ...
    <p class="alc"><img src="{{ asset('images/products/WE-D01c-06.jpg') }}"></p>
        <div>
