...
<div id="" class="main" role="main">
    ...
    <section class="product_content">
        <div class="flex">
        @foreach ($aptXhdProducts as $aptXhdProduct)
            <ul class="product_box mt20 mb20">
                <li class="alc"><a href="{{ $aptXhdProduct->link_detail }}">
                    <img src="{{ asset('images/thumbnails') }}/{{ $aptXhdProduct->thumbnail }}" alt="{{ $aptXhdProduct->product_name }}">
                </a></li>
                <li class="mt10 mb10"><h3>
                    <a href="{{ $aptXhdProduct->link_detail }}">{{ $aptXhdProduct->product_name }}</a>
                </h3></li>
                <li>
                    <p class="fs12">{!! Str::limit($aptXhdProduct->overview, 120) !!}</p>
                </li>
                <li class="alc mt20">
                    <a href="{{ $aptXhdProduct->link_detail }}" class="btn_product">詳細をみる</a>
                </li>
            </ul>
            @endforeach
        </div>
