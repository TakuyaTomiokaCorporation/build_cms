...
<div id="" class="main" role="main">
    ...
    <section class="product_content">
        <div class="flex">
        @foreach ($hybridProducts as $hybridProduct)
            <ul class="product_box mt20 mb20">
                <li class="alc"><a href="{{ $hybridProduct->link_detail }}">
                    <img src="{{ asset('images/thumbnails') }}/{{ $hybridProduct->thumbnail }}" alt="{{ $hybridProduct->product_name }}">
                </a></li>
                <li class="mt10 mb10"><h3>
                    <a href="{{ $hybridProduct->link_detail }}">{{ $hybridProduct->product_name }}</a>
                </h3></li>
                <li>
                    <p class="fs12">{!! Str::limit($hybridProduct->overview, 120) !!}</p>
                </li>
                <li class="alc mt20">
                    <a href="{{ $hybridProduct->link_detail }}" class="btn_product">詳細をみる</a>
                </li>
            </ul>
            @endforeach
        </div>
