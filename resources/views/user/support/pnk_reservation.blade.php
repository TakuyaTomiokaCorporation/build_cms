    ...
    <article class="w1020 w98 m_auto mb60">
            ...
            <p class="mb20">※<span class="required">必須</span>は入力必須項目となります。</p>
                ...
                @method('POST')    
                    ...
                    <input type="hidden" name="00N6F00000WyN80" value="C" />
                <dl>
            ...
            @endif
            <h3>ご予約の受付は終了いたしました。</h3>
            <div class="mt20">
                <p>たくさんのご予約、誠にありがとうございました。</p>
                <p>11月月末から各量販店にTE-Bd21f-pnkが並びますので、試聴等しながらじっくりご検討ください。</p>
                <p>今後ともAVIOTをどうぞよろしくお願いいたします。</p>
            </div>
        </div>
    </article>
